...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='arcnet', help='chooses which model to use')
        ...
        parser.add_argument('--verbose', action='store_true', help='if specified, print more the network architecture')
